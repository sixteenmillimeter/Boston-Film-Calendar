...
data.cal.categories = ['screening', 'meeting', 'workshop', 'other'];
...
data.cal.agx = function (obj) {
	'use strict';
	var format = 'M-D-YYYY HH:mm',
		site = 'http://dev.agxfilm.org';
	//'Saturday, April 9, 2016 - 15:00'
	obj.category = obj.category.toLowerCase();
	if (data.cal.categories.indexOf(obj.category) === -1) {
		obj.category = data.cal.categories[data.cal.categories - 1];
	}
